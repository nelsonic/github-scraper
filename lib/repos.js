...
module.exports = function repos ($, url, callback) {
  ...
  for(var i = 1; i < items.length; i++) {
    ...
    // http://stackoverflow.com/questions/9627756/using-javascript-to-read-value-from-itemprop
    // console.log($(parent + '.repo-list-stats > span[itemprop="programmingLanguage"]').first().text().trim())
    r.lang    = $(parent + '.repo-list-stats > span[itemprop="programmingLanguage"]').first().text().trim()
